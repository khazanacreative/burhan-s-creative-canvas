...
const SkillsSection = () => {
  return (
    <section className="snap-section gradient-bg-3 flex items-center justify-center p-4 md:p-8">
      <div className="container max-w-full mx-auto h-full flex flex-col">
        <div className="glass-morphism rounded-3xl p-6 md:p-8 flex-1 overflow-hidden flex flex-col">
            ...
            <div className="flex gap-6 min-w-max pr-4">
              {skillCategories.map((category, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="p-6 rounded-2xl bg-background/30 hover:bg-background/40 transition-all duration-300 animate-fade-in border border-primary/10 w-72"
          ...
          <div className="mt-4 p-4 rounded-2xl bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/30 flex-shrink-0">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div className="p-3">
                ...
                <p className="text-xs text-muted-foreground">Website Portfolios</p>
              </div>
            </div>
          </div>
        </div>
